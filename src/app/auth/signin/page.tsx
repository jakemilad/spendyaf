...
export default function SignIn() {
  return (
    <div className="h-[calc(100vh-65px)] w-full flex items-center justify-center bg-background relative overflow-hidden p-4 pb-20">
      ...
      >
        <div className="bg-card border rounded-3xl shadow-2xl p-8 sm:p-10 relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">  
                ...
                <p className="text-muted-foreground mb-8 text-sm max-w-[280px]">
                    Access your dashboard, manage transactions, and view your spending insights.
                </p>

                <Button 
                    size="lg"
                    onClick={() => signIn("google", { callbackUrl: "/dashboard" })}
                    className="w-full flex items-center gap-3 h-12 text-base relative overflow-hidden transition-all hover:scale-[1.02]"
                >
                ...
                <div className="mt-8 pt-8 border-t w-full flex justify-center">
                    <Link href="/" className="text-xs text-muted-foreground hover:text-primary flex items-center gap-1 transition-colors">
